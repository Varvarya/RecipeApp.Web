			...
			<div className='pop-up-content' onClick={undefined}>
				...
				<div className='content-container'>
					...
					<div className='children-container'>
						{Object.entries(fields).map((e: any, i: number) => <InputField key={i} value={e[1] || ''} name={e[0]} onChange={(value) => editFields({name: e[0], value: value.target.value})} placeholder={e[0]}></InputField>)}
					</div>
